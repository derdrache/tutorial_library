...
func _input(event):
	...
	elif event.is_action_pressed("reload"): gun.reload()
	elif event.is_action_pressed("nextGun"): gun.next_gun()
	elif event.is_action_pressed("previousGun"): gun.previuos_gun()

...
func _ready():
	...
	hurt_box.parried.connect(_on_parried)
	
func _on_parried():
	animation_player.play("Block_Hit")
...
func _physics_process(delta: float) -> void:
	...
	var runAnimation = animation_player.current_animation == "Running_A"
	var idleAnimation = animation_player.current_animation == "Idle"
	if animation_player.current_animation and not runAnimation and not idleAnimation:
		return

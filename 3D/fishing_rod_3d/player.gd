...
func _input(event):
	...
	if Input.is_action_just_pressed("shift") and not fishingStarted:
		fishingStarted = true
		set_physics_process(false)
		fishing_rod.start_fishing()
	elif Input.is_action_just_pressed("shift") and fishingStarted:
		fishingStarted = false
		set_physics_process(true)
		fishing_rod.stop_fishing()

...
const COMMAND_BUTTON = preload("res://tutorial_collection/turn_based_combat_series/turn_and_rounds/command_button.tscn")

const ATTACK = preload("res://tutorial_collection/turn_based_combat_series/turn_and_rounds/Attack.tres")
var skills = [preload("res://tutorial_collection/turn_based_combat_series/turn_and_rounds/heal.tres"), preload("res://tutorial_collection/turn_based_combat_series/turn_and_rounds/slash.tres")]

...
const PLAYER_STATS_CONTAINER = preload("res://tutorial_collection/turn_based_combat_series/status_bar/player_stats_container.tscn")

var playerList: Array = [preload("res://tutorial_collection/turn_based_combat_series/status_bar/resource/player1.tres"), 
	preload("res://tutorial_collection/turn_based_combat_series/status_bar/resource/player2.tres")]
...
func _set_player_agents() -> void:
	for player in playerList:
		...
		playerStatDisplay.set_player_stats(player)
